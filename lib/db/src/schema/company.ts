...
export const companyTable = pgTable("company", {
  ...
  healthInsuranceEmployeeRate: doublePrecision("health_insurance_employee_rate").notNull().default(0.0500),
  healthInsuranceEmployerRate: doublePrecision("health_insurance_employer_rate").notNull().default(0.0500),
